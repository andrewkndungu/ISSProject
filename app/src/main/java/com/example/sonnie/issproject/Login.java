...
public class Login extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_showpassword_checkBox=(CheckBox) findViewById(R.id.login_showpassword_checkBox);
        ...
        login_showpassword_checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
...
//Create the generateKey method that we’ll use to gain access to the Android keystore and generate the encryption key//
    ...
    private void loginUser(){
        ...
        if(!android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches()){
         Toast.makeText(this,"Invalid email address. Enter a valid email.",Toast.LENGTH_LONG);
            return;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                          ...
                          Toast.makeText(Login.this,"Login error. Kindly check your credentials",Toast.LENGTH_LONG);
